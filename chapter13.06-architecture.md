...
*Companion to [Recipe 13.6: Care Gap Reasoning Engine](chapter13.06-care-gap-reasoning-engine). This page covers the AWS architecture, services, prerequisites, and pseudocode. For the problem framing and the conceptual approach, start with the main recipe.*
