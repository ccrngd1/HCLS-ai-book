...
1. **Vendor BAA covers audio data-in-transit and at-rest within the vendor pipeline.** The vendor's Business Associate Agreement must explicitly cover the audio processing path the speech-to-text integration uses, including any intermediate storage within the vendor's infrastructure.
