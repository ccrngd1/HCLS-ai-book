...
**Investigation outcome.** Investigators adjudicate cases as confirmed violations, dismissals, or inconclusive. Confirmed violations trigger HR referral and (if unauthorized access of protected health information (PHI) is confirmed) the HIPAA breach notification clock. Outcomes are captured for the feedback loop.
...
- **Recipe 8.x (Clinical natural language processing (NLP) & Information Extraction):** Break-glass override reason extraction and policy-text analysis use NLP patterns from Chapter 8.
