...
- [CAQH CORE Operating Rules](https://www.caqh.org/core/): the operating rules constraining X12 270/271 transactions in US healthcare 
- [X12 EDI Standards](https://x12.org/): the standards body for the X12 transaction set 
...
- [HL7 Da Vinci Project](http://www.hl7.org/about/davinci/): industry collaborative defining FHIR implementation guides for payer-provider workflows 
- [CMS Interoperability and Patient Access Final Rule](https://www.cms.gov/Regulations-and-Guidance/Guidance/Interoperability/index): the regulatory framework requiring payer FHIR-based APIs 
...
- [CAQH Index Reports](https://www.caqh.org/explorations/caqh-index): annual reports on the state of healthcare administrative transactions, including eligibility-verification volumes and adoption rates 
