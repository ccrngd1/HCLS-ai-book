...
- **Recipe 8.x (Clinical natural language processing (NLP) & Information Extraction):** Nursing note feature extraction (Rothman-Index-style) uses NLP techniques covered in Chapter 8.
