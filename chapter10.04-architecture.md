...
- Logical Observation Identifiers Names and Codes (LOINC), from [loinc.org](https://loinc.org/): the standard for laboratory and clinical observation codes
