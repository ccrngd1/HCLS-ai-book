...
**Amazon S3 for image storage.** Lesion images are protected health information (PHI): identifiable medical photographs. They need encrypted, durable, auditable storage. S3 with SSE-KMS encryption, versioning, and lifecycle policies is the standard choice. Object Lock can enforce retention policies for compliance.
