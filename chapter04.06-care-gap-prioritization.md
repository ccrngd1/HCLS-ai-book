...
- **Recipe 8.x (Clinical NLP & Information Extraction):** Clinician override notes can be parsed by NLP to extract structured override reasons more reliably than relying on dropdown selections; the structured labels feed urgency-model retraining.
