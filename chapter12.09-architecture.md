...
- [`modern-time-series-forecasting-on-aws`](https://github.com/aws-samples/modern-time-series-forecasting-on-aws): Workshop demonstrating SageMaker-based time series forecasting with DeepAR, Chronos, AutoGluon, and custom algorithms
