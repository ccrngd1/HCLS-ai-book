...
- Briefing text stored in the briefings DynamoDB table is protected health information (PHI); it describes a specific patient's clinical situation and predicted treatment outcomes. Apply clinical-record-equivalent encryption and access controls.

**dead-letter queue (DLQ) coverage on all Lambda paths.** Three DLQ patterns in this architecture:
...
- [Yadlowsky et al., *Calibration of CATE estimators*](https://arxiv.org/abs/2104.04763): contemporary work on calibration of treatment-effect predictions 
...
- [Good Machine Learning Practice for Medical Device Development (FDA, Health Canada, MHRA)](https://www.fda.gov/medical-devices/software-medical-device-samd/good-machine-learning-practice-medical-device-development-guiding-principles) 
