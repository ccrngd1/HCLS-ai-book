...
- Health Level Seven (HL7): [HL7 FHIR Specification](https://www.hl7.org/fhir/) is the data model and API substrate for EHR integration
...
- Logical Observation Identifiers Names and Codes (LOINC): [LOINC](https://loinc.org/), standard lab and observation terminology
