...
**Buy versus build: neither, yet.** This is the one recipe in the flagship set where the honest recommendation is not to deploy at all outside a research protocol. There is nothing credible to buy, and the reason is the off-policy evaluation problem described below rather than a gap in the market. One distinction matters commercially and is easy to blur: sepsis *detection* has cleared regulatory review, and the FDA granted De Novo marketing authorization to Prenosis's Sepsis ImmunoScore in April 2024, the first AI sepsis diagnostic to receive it, for identifying patients at risk of having or developing sepsis. That is a different and far more tractable problem than recommending fluid volumes and vasopressor doses. If your institution wants to act on sepsis with AI today, buy detection and put the effort you saved into treatment-bundle compliance, which already has trial evidence behind it. Read this recipe to understand why treatment-policy optimization is hard and what would have to become true for it to be deployable, not as a build plan.
