...
What we're optimizing: find the policy π that maximizes expected cumulative reward. The math: π* = argmax E[Σ γ^t * r_t], where γ is a discount factor that weights near-term rewards more heavily than distant ones.
