...
**For inflow forecasting (Layer 1):** The same toolbox used for ED-arrival forecasting, plus deterministic schedule integration for surgical admits. Poisson regression with calendar and weather features handles ED-driven admissions. Multinomial classifiers handle service-line and unit assignment. The OR schedule is read directly. Direct admits and transfer requests are burstier, so they use negative binomial models with day-of-week features.
