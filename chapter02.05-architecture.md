...
- [HL7 FHIR Encounter Resource](https://www.hl7.org/fhir/encounter.html): The Health Level Seven (HL7) data model that drives encounter-scoped retrieval
