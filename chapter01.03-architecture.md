...
**Amazon S3, DynamoDB, SNS, and KMS.** Same services, same rationale as Recipe 1.2. Lab requisitions contain protected health information (PHI) and clinical information. Encrypt at rest with KMS, audit with CloudTrail, keep PHI in VPC-restricted resources.
