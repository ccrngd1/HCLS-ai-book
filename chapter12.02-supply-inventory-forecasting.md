...
| **BAA** | AWS BAA signed if consumption data is linked to specific patients or procedures (it usually is at the case level, even when aggregated to daily SKU counts; PHI considerations are conservative). |
...
<!-- TODO (TechWriter): N3. The Python companion file (chapter12.02-python-example.md) is referenced here but does not yet exist. Confirm it has been drafted before publishing this recipe. -->
