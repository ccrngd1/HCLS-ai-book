...
**False merges** (wrong-patient overlay) combine two real people into one record. The clinician sees one person's allergy list overlaid with another person's medications. This is the patient safety failure mode, and there are documented cases of it killing people. 
