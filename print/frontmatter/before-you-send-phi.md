<!--
Edit this file freely; it is the source for the front-matter page that appears after
"How to Use This Book" and before the first recipe. Plain markdown.

Placeholders substituted at build time from print/manifest.json:
  {title}  {year}  {author}  {recipe_count}  {digital_url}

If this file is deleted the build omits the page rather than failing.

House style: no em dashes, no emoji, abbreviations spelled out on first use.

Scope rule for this page: name the questions and say who owns them. Do not answer
them, do not describe how to satisfy any regulation, and do not imply that asking
these questions constitutes compliance. Every recipe in this book assumes the reader
has their own legal, privacy, and compliance functions, and this page routes to them.
-->
