...
<!-- TODO (TechWriter): Expert review A7 (HIGH) and S4 (MEDIUM). Two eligibility-filter gaps the expert review flagged need closing in the pseudocode and the architecture diagram, not just the prose:
