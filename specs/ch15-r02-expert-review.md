---
id: ch15-r02-expert-review
title: 'Expert Review: Notification Timing Optimization'
...
- type: file_exists
  ...
  paths:
  - reviews/chapter15.02-expert-review.md
- type: shell
  name: auto-fix-style
  commands:
  - python3 fix_style.py reviews/chapter15.02-expert-review.md
- type: persona_review
  name: quality-review
...
## Objective
Provide expert review of the Notification Timing Optimization recipe.
