---
id: ch08-r07-archsplit
title: 'Polish split: Adverse Event Detection Clinical Text'
...
- type: shell
  ...
  commands:
  - python3 check_split.py chapter08.07
- type: persona_review
