---
id: ch08-r01-archsplit
title: 'Polish split: Chief Complaint Classification'
...
- type: shell
  ...
  commands:
  - python3 check_split.py chapter08.01
- type: persona_review
