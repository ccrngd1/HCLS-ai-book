---
id: ch11-r08-code-review
title: 'Code Review: Mental Health Support Bot'
...
- type: file_exists
  ...
  paths:
  - reviews/chapter11.08-code-review.md
- type: shell
  name: auto-fix-style
  commands:
  - python3 fix_style.py reviews/chapter11.08-code-review.md
- type: persona_review
  name: quality-review
...
## Objective
Perform code review for recipe 11.8 Python companion.
