---
id: ch01-r10-archsplit
title: 'Polish split: Historical Chart Migration'
...
- type: file_exists
  ...
  paths:
  - chapter01.10-historical-chart-migration.md
  - chapter01.10-architecture.md
- type: shell
  name: structural-check
  commands:
  - python3 check_split.py chapter01.10
- type: persona_review
