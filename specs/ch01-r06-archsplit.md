---
id: ch01-r06-archsplit
title: 'Polish split: Handwritten Clinical Note Digitization'
...
- type: shell
  ...
  commands:
  - python3 check_split.py chapter01.06
- type: persona_review
