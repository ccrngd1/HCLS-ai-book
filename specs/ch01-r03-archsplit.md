---
id: ch01-r03-archsplit
title: 'Polish split: Lab Requisition Extraction'
...
- type: file_exists
  ...
  paths:
  - chapter01.03-lab-requisition-extraction.md
  - chapter01.03-architecture.md
- type: shell
  name: structural-check
  commands:
  - python3 check_split.py chapter01.03
- type: persona_review
