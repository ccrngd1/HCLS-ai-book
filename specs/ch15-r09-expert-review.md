---
id: ch15-r09-expert-review
title: 'Expert Review: Radiation Therapy Adaptive Planning'
...
- type: file_exists
  ...
  paths:
  - reviews/chapter15.09-expert-review.md
- type: shell
  name: auto-fix-style
  commands:
  - python3 fix_style.py reviews/chapter15.09-expert-review.md
- type: persona_review
  name: quality-review
...
## Objective
Provide expert review of the Radiation Therapy Adaptive Planning recipe.
