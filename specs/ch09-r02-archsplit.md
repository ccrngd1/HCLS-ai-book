---
id: ch09-r02-archsplit
title: 'Polish split: Patient Photo Verification'
...
- type: file_exists
  ...
  paths:
  - chapter09.02-patient-photo-verification.md
  - chapter09.02-architecture.md
- type: shell
  name: structural-check
  commands:
  - python3 check_split.py chapter09.02
- type: persona_review
