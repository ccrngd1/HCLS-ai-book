---
id: ch10-r10-expert-review
title: 'Expert Review: Multilingual Real-Time Medical Interpretation'
...
- type: file_exists
  ...
  paths:
  - reviews/chapter10.10-expert-review.md
- type: shell
  name: auto-fix-style
  commands:
  - python3 fix_style.py reviews/chapter10.10-expert-review.md
- type: persona_review
  name: quality-review
...
## Objective
Perform expert review for recipe 10.10 draft.
