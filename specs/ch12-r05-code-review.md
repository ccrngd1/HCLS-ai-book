---
id: ch12-r05-code-review
title: 'Code Review: Hospital Census Forecasting'
...
- type: file_exists
  ...
  paths:
  - reviews/chapter12.05-code-review.md
- type: shell
  name: auto-fix-style
  commands:
  - python3 fix_style.py reviews/chapter12.05-code-review.md
- type: persona_review
  name: quality-review
...
## Objective
Perform code review for recipe 12.5 Python companion.
