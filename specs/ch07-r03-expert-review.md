---
id: ch07-r03-expert-review
title: 'Expert Review: Patient Churn Disenrollment Prediction'
...
- type: file_exists
  ...
  paths:
  - reviews/chapter07.03-expert-review.md
- type: shell
  name: auto-fix-style
  commands:
  - python3 fix_style.py reviews/chapter07.03-expert-review.md
- type: persona_review
  name: quality-review
...
## Objective
Provide expert review of the Patient Churn Disenrollment Prediction recipe.
