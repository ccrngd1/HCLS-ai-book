---
id: ch14-r09-code-review
title: 'Code Review: Chemotherapy Scheduling'
...
- type: file_exists
  ...
  paths:
  - reviews/chapter14.09-code-review.md
- type: shell
  name: auto-fix-style
  commands:
  - python3 fix_style.py reviews/chapter14.09-code-review.md
- type: persona_review
  name: quality-review
...
## Objective
Review the Python companion code for Chemotherapy Scheduling.
