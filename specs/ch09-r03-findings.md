---
id: ch09-r03-findings
title: 'Resolve open findings: Recipe 9.3: Wound Photography Measurement'
...
- type: shell
  ...
  commands:
  - python3 check_findings.py chapter09.03
- type: persona_review
  name: findings-resolved
  persona: TechExpertReviewer
  pass_condition: >-
    Every open finding listed in chapter09.03-todo.md has been either (a) resolved
    ...
    security regressions. Resolved items removed from chapter09.03-todo.md. No new em dashes are introduced into the recipe source files.
---


## Objective
Resolve the open expert-review and code-review findings for Recipe 9.3: Wound Photography Measurement, listed in `chapter09.03-todo.md`.

## Inputs
- `chapter09.03-todo.md` (the open findings checklist).
- Reviewer context: `reviews/chapter09.03-expert-review.md`, `reviews/chapter09.03-code-review.md`.
- Recipe source files:
  - `chapter09.03-architecture.md`
  - `chapter09.03-python-example.md`
  - `chapter09.03-wound-photography-measurement.md`
...
## Instructions
1. Read `chapter09.03-todo.md` (and any review files above) for full context on each finding.
...
4. Remove each resolved entry from `chapter09.03-todo.md`.
5. If a finding needs an external citation you cannot verify, or a product decision only the author can make, leave it in `chapter09.03-todo.md` prefixed with `[NEEDS HUMAN]` and a one-line reason. Do not guess.
