---
id: ch11-r05-code-review
title: 'Code Review: Insurance Benefits Navigator'
...
- type: file_exists
  ...
  paths:
  - reviews/chapter11.05-code-review.md
- type: shell
  name: auto-fix-style
  commands:
  - python3 fix_style.py reviews/chapter11.05-code-review.md
- type: persona_review
  name: quality-review
...
## Objective
Perform code review for recipe 11.5 Python companion.
