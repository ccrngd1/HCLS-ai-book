---
id: ch13-r09-expert-review
title: 'Expert Review: Literature-Derived Knowledge Graph'
...
- type: file_exists
  ...
  paths:
  - reviews/chapter13.09-expert-review.md
- type: shell
  name: auto-fix-style
  commands:
  - python3 fix_style.py reviews/chapter13.09-expert-review.md
- type: persona_review
  name: quality-review
...
## Objective
Provide expert review of the Literature-Derived Knowledge Graph recipe.
