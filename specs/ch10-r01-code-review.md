---
id: ch10-r01-code-review
title: 'Code Review: IVR Call Routing Enhancement'
...
- type: file_exists
  ...
  paths:
  - reviews/chapter10.01-code-review.md
- type: shell
  name: auto-fix-style
  commands:
  - python3 fix_style.py reviews/chapter10.01-code-review.md
- type: persona_review
  name: quality-review
...
## Objective
Perform code review for recipe 10.1 Python companion.
