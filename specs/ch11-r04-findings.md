---
id: ch11-r04-findings
title: 'Resolve open findings: Recipe 11.4: Pre-Visit Intake Bot'
...
- type: file_exists
  ...
  paths:
  - chapter11.04-architecture.md
  - chapter11.04-pre-visit-intake-bot.md
  - chapter11.04-python-example.md
- type: shell
  name: findings-guardrail
  commands:
  - python3 check_findings.py chapter11.04
- type: persona_review
  name: findings-resolved
  persona: TechExpertReviewer
  pass_condition: >-
    Every open finding listed in chapter11.04-todo.md has been either (a) resolved
    ...
    security regressions. Resolved items removed from chapter11.04-todo.md. No new em dashes are introduced into the recipe source files.
---


## Objective
Resolve the open expert-review and code-review findings for Recipe 11.4: Pre-Visit Intake Bot, listed in `chapter11.04-todo.md`.

## Inputs
- `chapter11.04-todo.md` (the open findings checklist).
- Reviewer context: `reviews/chapter11.04-expert-review.md`, `reviews/chapter11.04-code-review.md`.
- Recipe source files:
  - `chapter11.04-architecture.md`
  - `chapter11.04-pre-visit-intake-bot.md`
  - `chapter11.04-python-example.md`
...
## Instructions
1. Read `chapter11.04-todo.md` (and any review files above) for full context on each finding.
...
4. Remove each resolved entry from `chapter11.04-todo.md`.
5. If a finding needs an external citation you cannot verify, or a product decision only the author can make, leave it in `chapter11.04-todo.md` prefixed with `[NEEDS HUMAN]` and a one-line reason. Do not guess.
