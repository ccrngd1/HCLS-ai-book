---
id: ch12-r10-findings
title: 'Resolve open findings: Recipe 12.10: Physiological Waveform Analysis'
...
- type: file_exists
  ...
  paths:
  - chapter12.10-architecture.md
  - chapter12.10-physiological-waveform-analysis.md
  - chapter12.10-python-example.md
- type: shell
  name: findings-guardrail
  commands:
  - python3 check_findings.py chapter12.10
- type: persona_review
  name: findings-resolved
  persona: TechExpertReviewer
  pass_condition: >-
    Every open finding listed in chapter12.10-todo.md has been either (a) resolved
    ...
    security regressions. Resolved items removed from chapter12.10-todo.md. No new em dashes are introduced into the recipe source files.
---


## Objective
Resolve the open expert-review and code-review findings for Recipe 12.10: Physiological Waveform Analysis, listed in `chapter12.10-todo.md`.

## Inputs
- `chapter12.10-todo.md` (the open findings checklist).
- Reviewer context: `reviews/chapter12.10-expert-review.md`, `reviews/chapter12.10-code-review.md`.
- Recipe source files:
  - `chapter12.10-architecture.md`
  - `chapter12.10-physiological-waveform-analysis.md`
  - `chapter12.10-python-example.md`
...
## Instructions
1. Read `chapter12.10-todo.md` (and any review files above) for full context on each finding.
...
4. Remove each resolved entry from `chapter12.10-todo.md`.
5. If a finding needs an external citation you cannot verify, or a product decision only the author can make, leave it in `chapter12.10-todo.md` prefixed with `[NEEDS HUMAN]` and a one-line reason. Do not guess.
