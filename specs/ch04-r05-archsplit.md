---
id: ch04-r05-archsplit
title: 'Polish split: Medication Adherence Intervention Targeting'
...
- type: shell
  ...
  commands:
  - python3 check_split.py chapter04.05
- type: persona_review
