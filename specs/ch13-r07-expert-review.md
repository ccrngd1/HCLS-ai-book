---
id: ch13-r07-expert-review
title: 'Expert Review: Disease-Gene-Drug Relationship Graph'
...
- type: file_exists
  ...
  paths:
  - reviews/chapter13.07-expert-review.md
- type: shell
  name: auto-fix-style
  commands:
  - python3 fix_style.py reviews/chapter13.07-expert-review.md
- type: persona_review
  name: quality-review
...
## Objective
Provide expert review of the Disease-Gene-Drug Relationship Graph recipe.
