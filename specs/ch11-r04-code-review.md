---
id: ch11-r04-code-review
title: "Code Review: Pre-Visit Intake Bot"
target_persona: TechCodeReviewer
tags: [chapter11, recipe, code-review]
depends_on: [ch11-r04-python]
validation:
  - type: file_exists
    name: output-file-exists
    paths: [reviews/chapter11.04-code-review.md]
  - type: persona_review
    name: quality-review
...
## Objective
Perform code review for recipe 11.4 Python companion.
