---
id: ch10-r04-code-review
title: 'Code Review: Medical Transcription Dictation'
...
- type: file_exists
  ...
  paths:
  - reviews/chapter10.04-code-review.md
- type: shell
  name: auto-fix-style
  commands:
  - python3 fix_style.py reviews/chapter10.04-code-review.md
- type: persona_review
  name: quality-review
...
## Objective
Perform code review for recipe 10.4 Python companion.
