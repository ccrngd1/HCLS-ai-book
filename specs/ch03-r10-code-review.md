---
id: ch03-r10-code-review
title: 'Code Review: Epidemic Outbreak Detection'
...
- type: file_exists
  ...
  paths:
  - reviews/chapter03.10-code-review.md
- type: shell
  name: auto-fix-style
  commands:
  - python3 fix_style.py reviews/chapter03.10-code-review.md
- type: persona_review
  name: quality-review
...
## Objective
Review the Python companion code for Epidemic Outbreak Detection.
