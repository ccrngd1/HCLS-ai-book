---
id: ch10-r07-findings
title: 'Resolve open findings: Recipe 10.7: Ambient Clinical Documentation ⭐⭐⭐'
...
- type: shell
  ...
  commands:
  - python3 check_findings.py chapter10.07
- type: persona_review
  name: findings-resolved
  persona: TechExpertReviewer
  pass_condition: >-
    Every open finding listed in chapter10.07-todo.md has been either (a) resolved
    ...
    security regressions. Resolved items removed from chapter10.07-todo.md. No new em dashes are introduced into the recipe source files.
---


## Objective
Resolve the open expert-review and code-review findings for Recipe 10.7: Ambient Clinical Documentation ⭐⭐⭐, listed in `chapter10.07-todo.md`.

## Inputs
- `chapter10.07-todo.md` (the open findings checklist).
- Reviewer context: `reviews/chapter10.07-expert-review.md`, `reviews/chapter10.07-code-review.md`.
- Recipe source files:
  - `chapter10.07-ambient-clinical-documentation.md`
  - `chapter10.07-architecture.md`
  - `chapter10.07-python-example.md`
...
## Instructions
1. Read `chapter10.07-todo.md` (and any review files above) for full context on each finding.
...
4. Remove each resolved entry from `chapter10.07-todo.md`.
5. If a finding needs an external citation you cannot verify, or a product decision only the author can make, leave it in `chapter10.07-todo.md` prefixed with `[NEEDS HUMAN]` and a one-line reason. Do not guess.
