---
id: ch03-r09-expert-review
title: 'Expert Review: Cybersecurity Access Pattern Anomalies'
...
- type: file_exists
  ...
  paths:
  - reviews/chapter03.09-expert-review.md
- type: shell
  name: auto-fix-style
  commands:
  - python3 fix_style.py reviews/chapter03.09-expert-review.md
- type: persona_review
  name: quality-review
...
## Objective
Provide expert review of the Cybersecurity Access Pattern Anomalies recipe.
