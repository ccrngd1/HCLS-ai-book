---
id: ch10-r05-code-review
title: 'Code Review: Patient-Facing Voice Assistant'
...
- type: file_exists
  ...
  paths:
  - reviews/chapter10.05-code-review.md
- type: shell
  name: auto-fix-style
  commands:
  - python3 fix_style.py reviews/chapter10.05-code-review.md
- type: persona_review
  name: quality-review
...
## Objective
Perform code review for recipe 10.5 Python companion.
