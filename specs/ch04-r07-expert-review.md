---
id: ch04-r07-expert-review
title: 'Expert Review: Care Management Program Enrollment'
...
- type: file_exists
  ...
  paths:
  - reviews/chapter04.07-expert-review.md
- type: shell
  name: auto-fix-style
  commands:
  - python3 fix_style.py reviews/chapter04.07-expert-review.md
- type: persona_review
  name: quality-review
...
## Objective
Provide expert review of the Care Management Program Enrollment recipe.
