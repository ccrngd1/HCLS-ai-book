---
id: ch03-r09-code-review
title: 'Code Review: Cybersecurity Access Pattern Anomalies'
...
- type: file_exists
  ...
  paths:
  - reviews/chapter03.09-code-review.md
- type: shell
  name: auto-fix-style
  commands:
  - python3 fix_style.py reviews/chapter03.09-code-review.md
- type: persona_review
  name: quality-review
...
## Objective
Review the Python companion code for Cybersecurity Access Pattern Anomalies.
