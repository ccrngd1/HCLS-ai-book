---
id: ch11-r01-findings
title: 'Resolve open findings: Recipe 11.1: FAQ Chatbot ⭐'
...
- type: file_exists
  ...
  paths:
  - chapter11.01-architecture.md
  - chapter11.01-faq-chatbot.md
  - chapter11.01-python-example.md
- type: shell
  name: findings-guardrail
  commands:
  - python3 check_findings.py chapter11.01
- type: persona_review
  name: findings-resolved
  persona: TechExpertReviewer
  pass_condition: >-
    Every open finding listed in chapter11.01-todo.md has been either (a) resolved
    ...
    security regressions. Resolved items removed from chapter11.01-todo.md. No new em dashes are introduced into the recipe source files.
---


## Objective
Resolve the open expert-review and code-review findings for Recipe 11.1: FAQ Chatbot ⭐, listed in `chapter11.01-todo.md`.

## Inputs
- `chapter11.01-todo.md` (the open findings checklist).
- Reviewer context: `reviews/chapter11.01-expert-review.md`, `reviews/chapter11.01-code-review.md`.
- Recipe source files:
  - `chapter11.01-architecture.md`
  - `chapter11.01-faq-chatbot.md`
  - `chapter11.01-python-example.md`
...
## Instructions
1. Read `chapter11.01-todo.md` (and any review files above) for full context on each finding.
...
4. Remove each resolved entry from `chapter11.01-todo.md`.
5. If a finding needs an external citation you cannot verify, or a product decision only the author can make, leave it in `chapter11.01-todo.md` prefixed with `[NEEDS HUMAN]` and a one-line reason. Do not guess.
