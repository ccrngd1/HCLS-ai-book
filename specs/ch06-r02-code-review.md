...
- type: file_exists
  ...
  paths:
  - reviews/chapter06.02-code-review.md
- type: shell
  name: auto-fix-style
  commands:
  - python3 fix_style.py reviews/chapter06.02-code-review.md
- type: persona_review
  name: quality-review
...
## Objective
Review the Python companion code for Utilization Pattern Segmentation.
