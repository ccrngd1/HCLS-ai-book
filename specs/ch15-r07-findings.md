---
id: ch15-r07-findings
title: 'Resolve open findings: Recipe 15.7: Chronic Disease Treatment Personalization'
...
- type: file_exists
  ...
  paths:
  - chapter15.07-architecture.md
  - chapter15.07-chronic-disease-treatment-personalization.md
  - chapter15.07-python-example.md
- type: shell
  name: findings-guardrail
  commands:
  - python3 check_findings.py chapter15.07
- type: persona_review
  name: findings-resolved
  persona: TechExpertReviewer
  pass_condition: >-
    Every open finding listed in chapter15.07-todo.md has been either (a) resolved
    ...
    security regressions. Resolved items removed from chapter15.07-todo.md. No new em dashes are introduced into the recipe source files.
---


## Objective
Resolve the open expert-review and code-review findings for Recipe 15.7: Chronic Disease Treatment Personalization, listed in `chapter15.07-todo.md`.

## Inputs
- `chapter15.07-todo.md` (the open findings checklist).
- Reviewer context: `reviews/chapter15.07-expert-review.md`, `reviews/chapter15.07-code-review.md`.
- Recipe source files:
  - `chapter15.07-architecture.md`
  - `chapter15.07-chronic-disease-treatment-personalization.md`
  - `chapter15.07-python-example.md`
...
## Instructions
1. Read `chapter15.07-todo.md` (and any review files above) for full context on each finding.
...
4. Remove each resolved entry from `chapter15.07-todo.md`.
5. If a finding needs an external citation you cannot verify, or a product decision only the author can make, leave it in `chapter15.07-todo.md` prefixed with `[NEEDS HUMAN]` and a one-line reason. Do not guess.
