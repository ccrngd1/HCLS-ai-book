...
- type: file_exists
  ...
  paths:
  - reviews/chapter08.03-expert-review.md
- type: shell
  name: auto-fix-style
  commands:
  - python3 fix_style.py reviews/chapter08.03-expert-review.md
- type: persona_review
  name: quality-review
...
## Objective
Provide expert review of the ICD-10 Code Suggestion recipe.
