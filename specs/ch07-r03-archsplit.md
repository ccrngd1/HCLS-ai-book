---
id: ch07-r03-archsplit
title: 'Polish split: Patient Churn Disenrollment Prediction'
...
- type: shell
  ...
  commands:
  - python3 check_split.py chapter07.03
- type: persona_review
