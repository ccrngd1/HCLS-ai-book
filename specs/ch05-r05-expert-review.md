---
id: ch05-r05-expert-review
title: 'Expert Review: Cross-Facility Patient Matching'
...
- type: file_exists
  ...
  paths:
  - reviews/chapter05.05-expert-review.md
- type: shell
  name: auto-fix-style
  commands:
  - python3 fix_style.py reviews/chapter05.05-expert-review.md
- type: persona_review
  name: quality-review
...
## Objective
Provide expert review of the Cross-Facility Patient Matching recipe.
