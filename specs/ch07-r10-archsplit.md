---
id: ch07-r10-archsplit
title: 'Polish split: Optimal Intervention Timing Prediction'
...
- type: shell
  ...
  commands:
  - python3 check_split.py chapter07.10
- type: persona_review
