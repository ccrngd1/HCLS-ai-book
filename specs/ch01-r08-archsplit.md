---
id: ch01-r08-archsplit
title: 'Polish split: Eob Processing'
...
- type: file_exists
  ...
  paths:
  - chapter01.08-eob-processing.md
  - chapter01.08-architecture.md
- type: shell
  name: structural-check
  commands:
  - python3 check_split.py chapter01.08
- type: persona_review
