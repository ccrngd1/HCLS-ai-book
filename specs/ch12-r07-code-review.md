---
id: ch12-r07-code-review
title: 'Code Review: Vital Sign Trajectory Monitoring'
...
- type: file_exists
  ...
  paths:
  - reviews/chapter12.07-code-review.md
- type: shell
  name: auto-fix-style
  commands:
  - python3 fix_style.py reviews/chapter12.07-code-review.md
- type: persona_review
  name: quality-review
...
## Objective
Perform code review for recipe 12.7 Python companion.
