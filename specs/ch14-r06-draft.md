...
- type: shell
  name: auto-fix-style
  commands:
  - python3 fix_style.py chapter14.06-patient-flow-bed-assignment.md
- type: persona_review
  name: quality-review
  persona: TechEditor
...
## Instructions
Write a complete recipe covering architecture patterns, implementation approach, hidden challenges, and limitations for Patient Flow Bed Assignment. Follow the cookbook format with problem statement, solution architecture, and production considerations. Include constraint formulation, solver selection, and real-time vs batch optimization tradeoffs.
