---
id: ch02-r10-expert-review
title: 'Expert Review: Multi-Modal Clinical Reasoning'
...
- type: file_exists
  ...
  paths:
  - reviews/chapter02.10-expert-review.md
- type: shell
  name: auto-fix-style
  commands:
  - python3 fix_style.py reviews/chapter02.10-expert-review.md
- type: persona_review
  name: quality-review
...
## Objective
Provide expert review of the Multi-Modal Clinical Reasoning recipe.
