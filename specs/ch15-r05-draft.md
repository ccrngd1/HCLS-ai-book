...
- type: shell
  name: auto-fix-style
  commands:
  - python fix_style.py chapter15.05-ventilator-weaning-protocols.md
- type: persona_review
  name: quality-review
  persona: TechEditor
...
## Objective
Draft the recipe for Ventilator Weaning Protocols using reinforcement learning.

## Instructions
Write a complete recipe covering architecture patterns, implementation approach, hidden challenges, and limitations for Ventilator Weaning Protocols. Follow the cookbook format with problem statement, solution architecture, and production considerations. Include state/action/reward formulation, safety constraints, and offline vs online learning tradeoffs.
