...
## Objective
Draft recipe 11.1 on FAQ Chatbot.

## Instructions
Write the full recipe covering faq chatbot in healthcare. Include use case description, architecture patterns, hidden challenges, and limitations/assumptions.
