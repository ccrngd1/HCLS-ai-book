---
id: ch13-r01-findings
title: 'Resolve open findings: Recipe 13.1: Drug Formulary Navigation ⭐'
...
- type: file_exists
  ...
  paths:
  - chapter13.01-architecture.md
  - chapter13.01-drug-formulary-navigation.md
  - chapter13.01-python-example.md
- type: shell
  name: findings-guardrail
  commands:
  - python3 check_findings.py chapter13.01
- type: persona_review
  name: findings-resolved
  persona: TechExpertReviewer
  pass_condition: >-
    Every open finding listed in chapter13.01-todo.md has been either (a) resolved
    ...
    security regressions. Resolved items removed from chapter13.01-todo.md. No new em dashes are introduced into the recipe source files.
---


## Objective
Resolve the open expert-review and code-review findings for Recipe 13.1: Drug Formulary Navigation ⭐, listed in `chapter13.01-todo.md`.

## Inputs
- `chapter13.01-todo.md` (the open findings checklist).
- Reviewer context: `reviews/chapter13.01-expert-review.md`, `reviews/chapter13.01-code-review.md`.
- Recipe source files:
  - `chapter13.01-architecture.md`
  - `chapter13.01-drug-formulary-navigation.md`
  - `chapter13.01-python-example.md`
...
## Instructions
1. Read `chapter13.01-todo.md` (and any review files above) for full context on each finding.
...
4. Remove each resolved entry from `chapter13.01-todo.md`.
5. If a finding needs an external citation you cannot verify, or a product decision only the author can make, leave it in `chapter13.01-todo.md` prefixed with `[NEEDS HUMAN]` and a one-line reason. Do not guess.
