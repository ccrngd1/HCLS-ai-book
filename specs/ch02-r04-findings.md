---
id: ch02-r04-findings
title: 'Resolve open findings: Recipe 2.4: Prior Authorization Letter Generation'
...
- type: file_exists
  ...
  paths:
  - chapter02.04-architecture.md
  - chapter02.04-prior-auth-letter-generation.md
  - chapter02.04-python-example.md
- type: shell
  name: findings-guardrail
  commands:
  - python3 check_findings.py chapter02.04
- type: persona_review
  name: findings-resolved
  persona: TechExpertReviewer
  pass_condition: >-
    Every open finding listed in chapter02.04-todo.md has been either (a) resolved
    ...
    security regressions. Resolved items removed from chapter02.04-todo.md. No new em dashes are introduced into the recipe source files.
---


## Objective
Resolve the open expert-review and code-review findings for Recipe 2.4: Prior Authorization Letter Generation, listed in `chapter02.04-todo.md`.

## Inputs
- `chapter02.04-todo.md` (the open findings checklist).
- Reviewer context: `reviews/chapter02.04-expert-review.md`, `reviews/chapter02.04-code-review.md`.
- Recipe source files:
  - `chapter02.04-architecture.md`
  - `chapter02.04-prior-auth-letter-generation.md`
  - `chapter02.04-python-example.md`
...
## Instructions
1. Read `chapter02.04-todo.md` (and any review files above) for full context on each finding.
...
4. Remove each resolved entry from `chapter02.04-todo.md`.
5. If a finding needs an external citation you cannot verify, or a product decision only the author can make, leave it in `chapter02.04-todo.md` prefixed with `[NEEDS HUMAN]` and a one-line reason. Do not guess.
