---
id: ch02-r04-code-review
title: 'Code Review: Prior Authorization Letter Generation'
...
- type: file_exists
  ...
  paths:
  - reviews/chapter02.04-code-review.md
- type: shell
  name: auto-fix-style
  commands:
  - python3 fix_style.py reviews/chapter02.04-code-review.md
- type: persona_review
  name: quality-review
...
## Objective
Review the Python companion code for Prior Authorization Letter Generation.
