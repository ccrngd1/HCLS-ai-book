---
id: ch04-r03-expert-review
title: 'Expert Review: Provider Directory Search Optimization'
...
- type: file_exists
  ...
  paths:
  - reviews/chapter04.03-expert-review.md
- type: shell
  name: auto-fix-style
  commands:
  - python3 fix_style.py reviews/chapter04.03-expert-review.md
- type: persona_review
  name: quality-review
...
## Objective
Provide expert review of the Provider Directory Search Optimization recipe.
