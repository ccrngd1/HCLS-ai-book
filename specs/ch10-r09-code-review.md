---
id: ch10-r09-code-review
title: 'Code Review: Speech Therapy Assessment and Monitoring'
...
- type: file_exists
  ...
  paths:
  - reviews/chapter10.09-code-review.md
- type: shell
  name: auto-fix-style
  commands:
  - python3 fix_style.py reviews/chapter10.09-code-review.md
- type: persona_review
  name: quality-review
...
## Objective
Perform code review for recipe 10.9 Python companion.
