---
id: ch05-r02-findings
title: 'Resolve open findings: Recipe 5.2: Provider NPI Matching ⭐'
...
- type: file_exists
  ...
  paths:
  - chapter05.02-architecture.md
  - chapter05.02-provider-npi-matching.md
  - chapter05.02-python-example.md
- type: shell
  name: findings-guardrail
  commands:
  - python3 check_findings.py chapter05.02
- type: persona_review
  name: findings-resolved
  persona: TechExpertReviewer
  pass_condition: >-
    Every open finding listed in chapter05.02-todo.md has been either (a) resolved
    ...
    security regressions. Resolved items removed from chapter05.02-todo.md. No new em dashes are introduced into the recipe source files.
---


## Objective
Resolve the open expert-review and code-review findings for Recipe 5.2: Provider NPI Matching ⭐, listed in `chapter05.02-todo.md`.

## Inputs
- `chapter05.02-todo.md` (the open findings checklist).
- Reviewer context: `reviews/chapter05.02-expert-review.md`, `reviews/chapter05.02-code-review.md`.
- Recipe source files:
  - `chapter05.02-architecture.md`
  - `chapter05.02-provider-npi-matching.md`
  - `chapter05.02-python-example.md`
...
## Instructions
1. Read `chapter05.02-todo.md` (and any review files above) for full context on each finding.
...
4. Remove each resolved entry from `chapter05.02-todo.md`.
5. If a finding needs an external citation you cannot verify, or a product decision only the author can make, leave it in `chapter05.02-todo.md` prefixed with `[NEEDS HUMAN]` and a one-line reason. Do not guess.
