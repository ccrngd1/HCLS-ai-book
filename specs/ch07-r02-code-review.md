---
id: ch07-r02-code-review
title: 'Code Review: Propensity to Pay Scoring'
...
- type: file_exists
  ...
  paths:
  - reviews/chapter07.02-code-review.md
- type: shell
  name: auto-fix-style
  commands:
  - python3 fix_style.py reviews/chapter07.02-code-review.md
- type: persona_review
  name: quality-review
...
## Objective
Review the Python companion code for Propensity to Pay Scoring.
