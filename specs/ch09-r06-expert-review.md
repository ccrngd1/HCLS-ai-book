...
- type: file_exists
  ...
  paths:
  - reviews/chapter09.06-expert-review.md
- type: shell
  name: auto-fix-style
  commands:
  - python3 fix_style.py reviews/chapter09.06-expert-review.md
- type: persona_review
  name: quality-review
...
## Objective
Provide expert review of the Diabetic Retinopathy Screening recipe.
