---
id: ch15-r07-archsplit
title: 'Polish split: Chronic Disease Treatment Personalization'
...
- type: shell
  ...
  commands:
  - python3 check_split.py chapter15.07
- type: persona_review
