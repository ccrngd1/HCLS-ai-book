---
id: ch14-r01-findings
title: 'Resolve open findings: Recipe 14.1: Appointment Slot Optimization'
...
- type: file_exists
  ...
  - chapter14.01-architecture.md
  - chapter14.01-python-example.md
- type: shell
  name: findings-guardrail
  commands:
  - python3 check_findings.py chapter14.01
- type: persona_review
  name: findings-resolved
  persona: TechExpertReviewer
  pass_condition: >-
    Every open finding listed in chapter14.01-todo.md has been either (a) resolved
    ...
    security regressions. Resolved items removed from chapter14.01-todo.md. No new em dashes are introduced into the recipe source files.
---


## Objective
Resolve the open expert-review and code-review findings for Recipe 14.1: Appointment Slot Optimization, listed in `chapter14.01-todo.md`.

## Inputs
- `chapter14.01-todo.md` (the open findings checklist).
- Reviewer context: `reviews/chapter14.01-expert-review.md`, `reviews/chapter14.01-code-review.md`.
- Recipe source files:
  - `chapter14.01-appointment-slot-optimization.md`
  - `chapter14.01-architecture.md`
  - `chapter14.01-python-example.md`
...
## Instructions
1. Read `chapter14.01-todo.md` (and any review files above) for full context on each finding.
...
4. Remove each resolved entry from `chapter14.01-todo.md`.
5. If a finding needs an external citation you cannot verify, or a product decision only the author can make, leave it in `chapter14.01-todo.md` prefixed with `[NEEDS HUMAN]` and a one-line reason. Do not guess.
