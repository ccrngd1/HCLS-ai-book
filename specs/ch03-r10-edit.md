---
id: ch03-r10-edit
title: 'Final Edit: Epidemic Outbreak Detection'
...
- edit
depends_on:
- ch03-r10-code-review
- ch03-r10-expert-review
validation:
- type: file_exists
...
- type: shell
  name: auto-fix-style
  commands:
  - python fix_style.py chapter03.10-epidemic-outbreak-detection.md
- type: persona_review
  name: quality-review
...
## Objective
Produce the final edited version of Epidemic Outbreak Detection.
