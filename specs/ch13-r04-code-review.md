...
- type: file_exists
  ...
  paths:
  - reviews/chapter13.04-code-review.md
- type: shell
  name: auto-fix-style
  commands:
  - python3 fix_style.py reviews/chapter13.04-code-review.md
- type: persona_review
  name: quality-review
...
## Objective
Review the Python companion code for Drug-Drug Interaction Knowledge Base.
