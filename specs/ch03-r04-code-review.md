---
id: ch03-r04-code-review
title: 'Code Review: Medication Dispensing Anomalies'
...
- type: file_exists
  ...
  paths:
  - reviews/chapter03.04-code-review.md
- type: shell
  name: auto-fix-style
  commands:
  - python3 fix_style.py reviews/chapter03.04-code-review.md
- type: persona_review
  name: quality-review
...
## Objective
Review the Python companion code for Medication Dispensing Anomalies.
