---
id: ch07-r04-archsplit
title: 'Polish split: Ed Visit Prediction'
...
- type: file_exists
  ...
  paths:
  - chapter07.04-ed-visit-prediction.md
  - chapter07.04-architecture.md
- type: shell
  name: structural-check
  commands:
  - python3 check_split.py chapter07.04
- type: persona_review
