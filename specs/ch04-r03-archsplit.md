---
id: ch04-r03-archsplit
title: 'Polish split: Provider Directory Search Optimization'
...
- type: shell
  ...
  commands:
  - python3 check_split.py chapter04.03
- type: persona_review
