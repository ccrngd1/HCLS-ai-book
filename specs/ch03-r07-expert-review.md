---
id: ch03-r07-expert-review
title: 'Expert Review: Patient Deterioration Early Warning'
...
- type: file_exists
  ...
  paths:
  - reviews/chapter03.07-expert-review.md
- type: shell
  name: auto-fix-style
  commands:
  - python3 fix_style.py reviews/chapter03.07-expert-review.md
- type: persona_review
  name: quality-review
...
## Objective
Provide expert review of the Patient Deterioration Early Warning recipe.
