---
id: ch05-r06-code-review
title: 'Code Review: Claims-to-Clinical Data Linkage'
...
- type: file_exists
  ...
  paths:
  - reviews/chapter05.06-code-review.md
- type: shell
  name: auto-fix-style
  commands:
  - python3 fix_style.py reviews/chapter05.06-code-review.md
- type: persona_review
  name: quality-review
...
## Objective
Review the Python companion code for Claims-to-Clinical Data Linkage.
