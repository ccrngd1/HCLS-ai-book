---
id: ch02-r07-code-review
title: 'Code Review: Literature Search and Evidence Synthesis'
...
- type: file_exists
  ...
  paths:
  - reviews/chapter02.07-code-review.md
- type: shell
  name: auto-fix-style
  commands:
  - python3 fix_style.py reviews/chapter02.07-code-review.md
- type: persona_review
  name: quality-review
...
## Objective
Review the Python companion code for Literature Search and Evidence Synthesis.
