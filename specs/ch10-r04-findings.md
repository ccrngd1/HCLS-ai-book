---
id: ch10-r04-findings
title: 'Resolve open findings: Recipe 10.4: Medical Transcription (Dictation) ⭐⭐'
...
- type: file_exists
  ...
  paths:
  - chapter10.04-architecture.md
  - chapter10.04-medical-transcription-dictation.md
  - chapter10.04-python-example.md
- type: shell
  name: findings-guardrail
  commands:
  - python3 check_findings.py chapter10.04
- type: persona_review
  name: findings-resolved
  persona: TechExpertReviewer
  pass_condition: >-
    Every open finding listed in chapter10.04-todo.md has been either (a) resolved
    ...
    security regressions. Resolved items removed from chapter10.04-todo.md. No new em dashes are introduced into the recipe source files.
---


## Objective
Resolve the open expert-review and code-review findings for Recipe 10.4: Medical Transcription (Dictation) ⭐⭐, listed in `chapter10.04-todo.md`.

## Inputs
- `chapter10.04-todo.md` (the open findings checklist).
- Reviewer context: `reviews/chapter10.04-expert-review.md`, `reviews/chapter10.04-code-review.md`.
- Recipe source files:
  - `chapter10.04-architecture.md`
  - `chapter10.04-medical-transcription-dictation.md`
  - `chapter10.04-python-example.md`
...
## Instructions
1. Read `chapter10.04-todo.md` (and any review files above) for full context on each finding.
...
4. Remove each resolved entry from `chapter10.04-todo.md`.
5. If a finding needs an external citation you cannot verify, or a product decision only the author can make, leave it in `chapter10.04-todo.md` prefixed with `[NEEDS HUMAN]` and a one-line reason. Do not guess.
