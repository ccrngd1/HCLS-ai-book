...
- type: file_exists
  ...
  paths:
  - reviews/chapter06.05-expert-review.md
- type: shell
  name: auto-fix-style
  commands:
  - python3 fix_style.py reviews/chapter06.05-expert-review.md
- type: persona_review
  name: quality-review
...
## Objective
Provide expert review of the Provider Practice Pattern Analysis recipe.
