---
id: ch02-r02-expert-review
title: 'Expert Review: Medical Terminology Simplification'
...
- type: file_exists
  ...
  paths:
  - reviews/chapter02.02-expert-review.md
- type: shell
  name: auto-fix-style
  commands:
  - python3 fix_style.py reviews/chapter02.02-expert-review.md
- type: persona_review
  name: quality-review
...
## Objective
Provide expert review of the Medical Terminology Simplification recipe.
