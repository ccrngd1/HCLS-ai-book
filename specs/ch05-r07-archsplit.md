---
id: ch05-r07-archsplit
title: 'Polish split: Longitudinal Patient Matching Name Changes'
...
- type: shell
  ...
  commands:
  - python3 check_split.py chapter05.07
- type: persona_review
