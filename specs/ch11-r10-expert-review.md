---
id: ch11-r10-expert-review
title: 'Expert Review: Clinical Trial Recruitment Conversationalist'
...
- type: file_exists
  ...
  paths:
  - reviews/chapter11.10-expert-review.md
- type: shell
  name: auto-fix-style
  commands:
  - python3 fix_style.py reviews/chapter11.10-expert-review.md
- type: persona_review
  name: quality-review
...
## Objective
Perform expert review for recipe 11.10 draft.
