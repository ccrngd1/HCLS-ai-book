---
id: ch07-r07-expert-review
title: 'Expert Review: Length of Stay Prediction'
...
- type: file_exists
  ...
  paths:
  - reviews/chapter07.07-expert-review.md
- type: shell
  name: auto-fix-style
  commands:
  - python3 fix_style.py reviews/chapter07.07-expert-review.md
- type: persona_review
  name: quality-review
...
## Objective
Provide expert review of the Length of Stay Prediction recipe.
