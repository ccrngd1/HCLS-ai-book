---
id: ch15-r06-expert-review
title: 'Expert Review: Glucose Control in ICU'
...
- type: file_exists
  ...
  paths:
  - reviews/chapter15.06-expert-review.md
- type: shell
  name: auto-fix-style
  commands:
  - python3 fix_style.py reviews/chapter15.06-expert-review.md
- type: persona_review
  name: quality-review
...
## Objective
Provide expert review of the Glucose Control in ICU recipe.
