---
id: ch10-r02-archsplit
title: 'Polish split: Voicemail Transcription Classification'
...
- type: shell
  ...
  commands:
  - python3 check_split.py chapter10.02
- type: persona_review
