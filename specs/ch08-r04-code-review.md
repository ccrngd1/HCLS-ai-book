...
- type: file_exists
  ...
  paths:
  - reviews/chapter08.04-code-review.md
- type: shell
  name: auto-fix-style
  commands:
  - python3 fix_style.py reviews/chapter08.04-code-review.md
- type: persona_review
  name: quality-review
...
## Objective
Review the Python companion code for Medication Extraction and Normalization.
