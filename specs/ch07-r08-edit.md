...
- edit
depends_on:
- ch07-r08-code-review
- ch07-r08-expert-review
validation:
- type: file_exists
...
- type: shell
  name: auto-fix-style
  commands:
  - python3 fix_style.py chapter07.08-disease-progression-modeling.md
- type: persona_review
  name: quality-review
...
## Objective
Produce the final edited version of Disease Progression Modeling.
