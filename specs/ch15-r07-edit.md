...
depends_on: [ch15-r07-code-review, ch15-r07-expert-review]
validation:
  - type: file_exists
    name: output-file-exists
    paths: [chapter15.07-chronic-disease-treatment-personalization.md]
  - type: persona_review
    name: quality-review
...
## Objective
Produce the final edited version of the Chronic Disease Treatment Personalization recipe.
