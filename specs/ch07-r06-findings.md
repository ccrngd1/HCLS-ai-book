---
id: ch07-r06-findings
title: 'Resolve open findings: Recipe 7.6: Rising Risk Identification'
...
- type: file_exists
  ...
  - chapter07.06-python-example.md
  - chapter07.06-rising-risk-identification.md
- type: shell
  name: findings-guardrail
  commands:
  - python3 check_findings.py chapter07.06
- type: persona_review
  name: findings-resolved
  persona: TechExpertReviewer
  pass_condition: >-
    Every open finding listed in chapter07.06-todo.md has been either (a) resolved
    ...
    security regressions. Resolved items removed from chapter07.06-todo.md. No new em dashes are introduced into the recipe source files.
---


## Objective
Resolve the open expert-review and code-review findings for Recipe 7.6: Rising Risk Identification, listed in `chapter07.06-todo.md`.

## Inputs
- `chapter07.06-todo.md` (the open findings checklist).
- Reviewer context: `reviews/chapter07.06-expert-review.md`, `reviews/chapter07.06-code-review.md`.
- Recipe source files:
  - `chapter07.06-architecture.md`
  - `chapter07.06-python-example.md`
  - `chapter07.06-rising-risk-identification.md`
...
## Instructions
1. Read `chapter07.06-todo.md` (and any review files above) for full context on each finding.
...
4. Remove each resolved entry from `chapter07.06-todo.md`.
5. If a finding needs an external citation you cannot verify, or a product decision only the author can make, leave it in `chapter07.06-todo.md` prefixed with `[NEEDS HUMAN]` and a one-line reason. Do not guess.
