---
id: ch05-r10-archsplit
title: 'Polish split: Deceased Patient Resolution Reconciliation'
...
- type: shell
  ...
  commands:
  - python3 check_split.py chapter05.10
- type: persona_review
