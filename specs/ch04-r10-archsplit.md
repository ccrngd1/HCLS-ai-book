---
id: ch04-r10-archsplit
title: 'Polish split: Dynamic Treatment Regime Recommendation'
...
- type: shell
  ...
  commands:
  - python3 check_split.py chapter04.10
- type: persona_review
