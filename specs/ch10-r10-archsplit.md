---
id: ch10-r10-archsplit
title: 'Polish split: Multilingual Realtime Medical Interpretation'
...
- type: shell
  ...
  commands:
  - python3 check_split.py chapter10.10
- type: persona_review
