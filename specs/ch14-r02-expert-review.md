---
id: ch14-r02-expert-review
title: 'Expert Review: Patient-Provider Assignment'
...
- type: file_exists
  ...
  paths:
  - reviews/chapter14.02-expert-review.md
- type: shell
  name: auto-fix-style
  commands:
  - python3 fix_style.py reviews/chapter14.02-expert-review.md
- type: persona_review
  name: quality-review
...
## Objective
Provide expert review of the Patient-Provider Assignment recipe.
