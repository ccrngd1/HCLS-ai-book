---
id: ch04-r01-archsplit
title: 'Polish split: Appointment Reminder Channel Optimization'
...
- type: shell
  ...
  commands:
  - python3 check_split.py chapter04.01
- type: persona_review
