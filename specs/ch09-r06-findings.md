---
id: ch09-r06-findings
title: 'Resolve open findings: Recipe 9.6: Diabetic Retinopathy Screening'
...
- type: file_exists
  ...
  - chapter09.06-python-example.md
- type: shell
  name: findings-guardrail
  commands:
  - python3 check_findings.py chapter09.06
- type: persona_review
  name: findings-resolved
  persona: TechExpertReviewer
  pass_condition: >-
    Every open finding listed in chapter09.06-todo.md has been either (a) resolved
    ...
    security regressions. Resolved items removed from chapter09.06-todo.md. No new em dashes are introduced into the recipe source files.
---


## Objective
Resolve the open expert-review and code-review findings for Recipe 9.6: Diabetic Retinopathy Screening, listed in `chapter09.06-todo.md`.

## Inputs
- `chapter09.06-todo.md` (the open findings checklist).
- Reviewer context: `reviews/chapter09.06-expert-review.md`, `reviews/chapter09.06-code-review.md`.
- Recipe source files:
  - `chapter09.06-architecture.md`
  - `chapter09.06-diabetic-retinopathy-screening.md`
  - `chapter09.06-python-example.md`
...
## Instructions
1. Read `chapter09.06-todo.md` (and any review files above) for full context on each finding.
...
4. Remove each resolved entry from `chapter09.06-todo.md`.
5. If a finding needs an external citation you cannot verify, or a product decision only the author can make, leave it in `chapter09.06-todo.md` prefixed with `[NEEDS HUMAN]` and a one-line reason. Do not guess.
