---
id: ch10-r02-code-review
title: 'Code Review: Voicemail Transcription and Classification'
...
- type: file_exists
  ...
  paths:
  - reviews/chapter10.02-code-review.md
- type: shell
  name: auto-fix-style
  commands:
  - python3 fix_style.py reviews/chapter10.02-code-review.md
- type: persona_review
  name: quality-review
...
## Objective
Perform code review for recipe 10.2 Python companion.
