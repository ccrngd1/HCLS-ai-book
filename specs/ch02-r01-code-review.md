---
id: ch02-r01-code-review
title: 'Code Review: Patient Message Response Drafting'
...
- type: file_exists
  ...
  paths:
  - reviews/chapter02.01-code-review.md
- type: shell
  name: auto-fix-style
  commands:
  - python3 fix_style.py reviews/chapter02.01-code-review.md
- type: persona_review
  name: quality-review
...
## Objective
Review the Python companion code for Patient Message Response Drafting.
