---
id: ch03-r03-expert-review
title: 'Expert Review: Billing Code Anomalies'
...
- type: file_exists
  ...
  paths:
  - reviews/chapter03.03-expert-review.md
- type: shell
  name: auto-fix-style
  commands:
  - python3 fix_style.py reviews/chapter03.03-expert-review.md
- type: persona_review
  name: quality-review
...
## Objective
Provide expert review of the Billing Code Anomalies recipe.
