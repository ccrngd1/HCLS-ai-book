---
id: ch12-r02-expert-review
title: 'Expert Review: Supply Inventory Forecasting'
...
- type: file_exists
  ...
  paths:
  - reviews/chapter12.02-expert-review.md
- type: shell
  name: auto-fix-style
  commands:
  - python3 fix_style.py reviews/chapter12.02-expert-review.md
- type: persona_review
  name: quality-review
...
## Objective
Perform expert review for recipe 12.2 draft.
