---
id: ch13-r08-archsplit
title: 'Polish split: Medical Concept Normalization Mapping'
...
- type: shell
  ...
  commands:
  - python3 check_split.py chapter13.08
- type: persona_review
