---
id: ch15-r01-archsplit
title: 'Polish split: Alert Threshold Optimization'
...
- type: shell
  ...
  commands:
  - python3 check_split.py chapter15.01
- type: persona_review
