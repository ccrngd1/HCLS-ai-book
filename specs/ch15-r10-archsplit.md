---
id: ch15-r10-archsplit
title: 'Polish split: Hospital Resource Allocation Uncertainty'
...
- type: shell
  ...
  commands:
  - python3 check_split.py chapter15.10
- type: persona_review
