---
id: ch14-r01-archsplit
title: 'Polish split: Appointment Slot Optimization'
...
- type: shell
  ...
  commands:
  - python3 check_split.py chapter14.01
- type: persona_review
