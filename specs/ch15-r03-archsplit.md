---
id: ch15-r03-archsplit
title: 'Polish split: Clinical Trial Adaptive Randomization'
...
- type: shell
  ...
  commands:
  - python3 check_split.py chapter15.03
- type: persona_review
