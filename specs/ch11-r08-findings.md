---
id: ch11-r08-findings
title: 'Resolve open findings: Recipe 11.8: Mental Health Support Bot'
...
- type: file_exists
  ...
  paths:
  - chapter11.08-architecture.md
  - chapter11.08-mental-health-support-bot.md
  - chapter11.08-python-example.md
- type: shell
  name: findings-guardrail
  commands:
  - python3 check_findings.py chapter11.08
- type: persona_review
  name: findings-resolved
  persona: TechExpertReviewer
  pass_condition: >-
    Every open finding listed in chapter11.08-todo.md has been either (a) resolved
    ...
    security regressions. Resolved items removed from chapter11.08-todo.md. No new em dashes are introduced into the recipe source files.
---


## Objective
Resolve the open expert-review and code-review findings for Recipe 11.8: Mental Health Support Bot, listed in `chapter11.08-todo.md`.

## Inputs
- `chapter11.08-todo.md` (the open findings checklist).
- Reviewer context: `reviews/chapter11.08-expert-review.md`.
- Recipe source files:
  - `chapter11.08-architecture.md`
  - `chapter11.08-mental-health-support-bot.md`
  - `chapter11.08-python-example.md`
...
## Instructions
1. Read `chapter11.08-todo.md` (and any review files above) for full context on each finding.
...
4. Remove each resolved entry from `chapter11.08-todo.md`.
5. If a finding needs an external citation you cannot verify, or a product decision only the author can make, leave it in `chapter11.08-todo.md` prefixed with `[NEEDS HUMAN]` and a one-line reason. Do not guess.
