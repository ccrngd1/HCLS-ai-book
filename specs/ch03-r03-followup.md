...
- type: shell
  ...
  commands:
  - 'python -c "import re,sys,pathlib; t=pathlib.Path(''chapter03.03-billing-code-anomalies.md'').read_text(encoding=''utf-8'');
...
- type: shell
  name: auto-fix-style
  commands:
  - python fix_style.py chapter03.03-billing-code-anomalies.md
- type: persona_review
