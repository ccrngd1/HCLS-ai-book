---
id: ch05-r07-expert-review
title: 'Expert Review: Longitudinal Patient Matching Across Name Changes'
...
- type: file_exists
  ...
  paths:
  - reviews/chapter05.07-expert-review.md
- type: shell
  name: auto-fix-style
  commands:
  - python3 fix_style.py reviews/chapter05.07-expert-review.md
- type: persona_review
  name: quality-review
...
## Objective
Provide expert review of the Longitudinal Patient Matching Across Name Changes recipe.
