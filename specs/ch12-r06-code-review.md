---
id: ch12-r06-code-review
title: 'Code Review: Revenue Cycle Cash Flow Forecasting'
...
- type: file_exists
  ...
  paths:
  - reviews/chapter12.06-code-review.md
- type: shell
  name: auto-fix-style
  commands:
  - python3 fix_style.py reviews/chapter12.06-code-review.md
- type: persona_review
  name: quality-review
...
## Objective
Perform code review for recipe 12.6 Python companion.
