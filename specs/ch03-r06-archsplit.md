---
id: ch03-r06-archsplit
title: 'Polish split: Healthcare Fraud Waste Abuse Detection'
...
- type: shell
  ...
  commands:
  - python3 check_split.py chapter03.06
- type: persona_review
