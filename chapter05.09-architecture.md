...
*Companion to [Recipe 5.9: National-Scale Patient Matching (TEFCA)](chapter05.09-national-scale-patient-matching). This page covers the AWS architecture, services, prerequisites, and pseudocode. For the problem framing and the conceptual approach, start with the main recipe.*
...
> - Health Level Seven (HL7) publishes the Fast Healthcare Interoperability Resources (FHIR) specification at [HL7 FHIR](https://www.hl7.org/fhir/), including the Patient $match operation and the Bulk FHIR specification used in TEFCA's emerging FHIR-based exchange patterns.
> - The [Carequality](https://carequality.org/) framework is a related pre-TEFCA national framework whose patterns inform some of TEFCA's operational specifications. 
...
- [The Common Agreement](https://rce.sequoiaproject.org/): the legal contract that QHINs sign with the RCE and with each other 
- [QHIN Technical Framework (QTF)](https://rce.sequoiaproject.org/): the technical specification for cross-QHIN interoperability 
...
- [42 CFR Part 2](https://www.ecfr.gov/current/title-42/chapter-I/subchapter-A/part-2): the substance-use-treatment record disclosure framework that imposes specific constraints on TEFCA-mediated exchange 
...
- [eHealth Exchange](https://ehealthexchange.org/): one of the pre-TEFCA national exchange networks that has transitioned to QHIN designation 
...
- [Sequoia Project Patient Matching Framework](https://sequoiaproject.org/): industry-developed framework for patient-matching that informs the cross-network matching expectations 
- [HIMSS Interoperability Resources](https://www.himss.org/): industry-association resources on healthcare interoperability including TEFCA implementation guidance 
